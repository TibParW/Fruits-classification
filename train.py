...
รองรับการสเกลระดับ 300 ชนิดผลไม้ (Fruits-360 + ผลไม้ไทยและผลไม้เขตร้อนหายากจาก Fruit-262)
...
# พจนานุกรมคำแปลภาษาไทยและ Emoji สำหรับผลไม้และพืชผล 300 คลาส
FRUIT_KEYWORD_MAP = {
    "apple": ("แอปเปิ้ล", "🍎"),
    "almond": ("อัลมอนด์", "🥜"),
    "apricot": ("แอปริคอต", "🍑"),
    ...
    "watermelon": ("แตงโม", "🍉"),
    "zucchini": ("ซูกินี", "🥒"),
    # ผลไม้ไทยและผลไม้เขตร้อนหายาก (จาก Fruit-262)
    ...
    "breadfruit": ("สาเก", "🍈"),
    "burmese grape": ("มะไฟ", "🍇"),
    "caimito": ("ลูกน้ำนม/สตาร์แอปเปิ้ล", "🟣"),
    "canistel": ("เซียนท้อ/ม่อนไข่", "🟡"),
    "cempedak": ("จำปาดะ", "🍈"),
    "cluster fig": ("มะเดื่ออุทุมพร", "🪵"),
    "custard apple": ("น้อยหน่า", "🍈"),
    "sugar apple": ("น้อยหน่า", "🍈"),
    "elephant apple": ("มะขวิด", "🪵"),
    "emblic": ("มะขามป้อม", "🫒"),
    "gandaria": ("มะปราง/มะยงชิด", "🥭"),
    "hog plum": ("มะกอกป่า", "🫒"),
    "jackfruit": ("ขนุน", "🍈"),
    "jamaica cherry": ("ตะขบฝรั่ง", "🍒"),
    "jambul": ("ลูกหว้า", "🫐"),
    "jujube": ("พุทรา", "🫒"),
    "kaffir lime": ("มะกรูด", "🍋"),
    "kaffir": ("มะกรูด", "🍋"),
    "langsat": ("ลองกอง/ลางสาด", "🍇"),
    "longan": ("ลำไย", "🌰"),
    "mabolo": ("มะริด", "🍎"),
    "malay apple": ("ชมพู่มะเหมี่ยว", "🍎"),
    "manila tamarind": ("มะขามเทศ", "🥜"),
    "monkfruit": ("หล่อฮังก๊วย", "🟤"),
    "morinda": ("ลูกยอ", "🥔"),
    "mundu": ("มะพูด", "🟡"),
    "pulasan": ("พูลัสซัน/เงาะสั้น", "🔴"),
    "santol": ("กระท้อน", "🟡"),
    "sapodilla": ("ละมุด", "🥔"),
    "velvet tamarind": ("ลูกหยี", "🫘"),
}
