...
![Accuracy](https://img.shields.io/badge/Test%20Accuracy-99.40%25-brightgreen.svg)
...
3. **ทำงานได้บนระบบคลาวด์ขนาดเล็ก:** โมเดลมีขนาดกะทัดรัด (เพียง 3.23 MB) และกินหน่วยความจำต่ำมาก (< 100 MB RAM) ทำให้ประหยัดต้นทุนเซิร์ฟเวอร์ และทำงานได้อย่างรวดเร็วบนคลาวด์ฟรีเทียร์
...
* **Fruits-360 Dataset (Kaggle):** รวบรวมโดย Mihai Oltean เผยแพร่ภายใต้สัญญาอนุญาต CC BY-SA 4.0 เป็นภาพผลไม้และพืชผลทางการเกษตร 267 สายพันธุ์ในสตูดิโอที่มีแสงสม่ำเสมอ หมุน 360 องศา และฉากหลังสีขาวมาตรฐาน
...
* **จำนวนภาพรวมทั้งหมด:** **6,675 รูปภาพ** ($267 \times 25$)
