...
## Machine Learning Image Classification & Gradio Web Application (267 Classes)
...
![Classes](https://img.shields.io/badge/Classes-267%20Fruits-success.svg)
![Accuracy](https://img.shields.io/badge/Test%20Accuracy-98.84%25-brightgreen.svg)
![Samples](https://img.shields.io/badge/Samples-27%2C168%20Images-blue.svg)
...
1. **เพิ่มความแม่นยำและความเร็ว:** ช่วยระบุสายพันธุ์ผลไม้ได้อย่างรวดเร็วในเสี้ยววินาที รองรับการจำแนกได้ละเอียดถึง **267 คลาส**
2. **ขยายขนาดชุดข้อมูลครอบคลุมสูง:** ฝึกสอนบนภาพตัวอย่างกว่า **27,168 รูปภาพ** พร้อมเทคนิค Data Augmentation รองรับภาพหลากหลายสภาพแวดล้อม
3. **ทำงานได้บนระบบคลาวด์ขนาดเล็ก:** โมเดลมีขนาดกะทัดรัด (เพียง 3.09 MB) และกินหน่วยความจำต่ำมาก (< 100 MB RAM) ทำให้ประหยัดต้นทุนเซิร์ฟเวอร์ และทำงานได้อย่างรวดเร็วบนคลาวด์ฟรีเทียร์
...
ชุดข้อมูลรวบรวมและคัดเลือกจากแหล่งข้อมูลเปิดมาตรฐานสากล:
* **Fruits-360 Dataset (Kaggle):** รวบรวมโดย Mihai Oltean เผยแพร่ภายใต้สัญญาอนุญาต CC BY-SA 4.0 เป็นภาพผลไม้และพืชผลทางการเกษตร 267 สายพันธุ์ในสตูดิโอที่มีแสงสม่ำเสมอ หมุน 360 องศา
* **Fruit-262 Dataset (Kaggle):** เสริมภาพผลไม้จริงตามธรรมชาติและภาพผลไม้ผ่าครึ่ง (เช่น แก้วมังกรเนื้อขาว, ทุเรียน)

### 2.2 จำนวนข้อมูลและการแบ่งชุดฝึก/ชุดทดสอบ (Dataset Distribution)
* **จำนวนคลาสทั้งหมด:** **267 คลาส (Classes)**
* **จำนวนภาพรวมทั้งหมด:** **27,168 รูปภาพ** (เฉลี่ย ~100 รูปภาพ/คลาส รวม Augmentation)
* **การแบ่งชุดข้อมูล (Data Splitting):** ใช้วิธี **Stratified Train-Test Split (80:20)** โดยกำหนด `random_state=42` และ `stratify=y` เพื่อคงสัดส่วนข้อมูลในทุกคลาสอย่างสมดุล:
  * **ชุดฝึกสอน (Train Set 80%):** **21,734 รูปภาพ**
  * **ชุดทดสอบ (Test Set 20%):** **5,434 รูปภาพ**
